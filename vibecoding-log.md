...
- [Faz 3] domain: Pencere Sonu Bilgi Sızıntısı (cevabı bilen örnekler) | tech: Örnekleme Dağılımı Hizalama (train=serve)
- [Faz 3] domain: Eşik Ölüm Sarmalı (az işlem -> sıkılaştır -> daha az işlem) | tech: Model Sürüm Damgası ile otomatik sıfırlama
